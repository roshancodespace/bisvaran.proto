                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-5xl font-medium tracking-tight text-zinc-900 mb-6 leading-tight">
                            Professional care in the <br className="hidden sm:block" />
                            <span className="text-teal-500 italic">comfort of your home.</span>
                        </h1>
                        <p className="text-lg text-zinc-600 mb-8 max-w-xl leading-relaxed">
                            Our verified, highly trained nurses provide compassionate, round-the-clock care tailored to your specific medical needs—from post-operative recovery to elder care and chronic disease management.
                        </p>
                    ...
                    <div className="relative w-full aspect-square max-w-md mx-auto">
                        ...
                        <img
                            src="/home-nursing.png"
                            alt="Home Nursing Illustration"
