            ...
            <div className="grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-24 w-full flex flex-col">
                <div className="max-w-3xl">
                    ...
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-medium tracking-tight text-zinc-900 mb-6 leading-tight">
                        Browse top-tier <br className="hidden sm:block" />
                        <span className="text-teal-500 italic">Hospitals.</span>
                    </h1>

                    <p className="text-lg sm:text-xl text-zinc-600 leading-relaxed mb-8">
                        Our curated network consists only of healthcare facilities that meet our rigorous standards for quality, modern amenities, and patient satisfaction.
                    </p>

                    <div className="bg-white p-8 rounded-3xl shadow-sm border border-zinc-100 flex justify-between items-center mb-12">
                        <div>
                            <h3 className="text-xl font-medium text-zinc-900 mb-2">Ready to explore facilities?</h3>
                            <p className="text-zinc-600">Filter by location and specialty to find the right hospital for you.</p>
                        </div>
                        <Link href="/hospitals" className="px-6 py-3 bg-teal-600 hover:bg-teal-700 text-white rounded-xl font-medium shadow-sm transition-colors text-nowrap">
                            View Hospitals Directory
                        </Link>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-zinc-100/50 p-6 rounded-2xl border border-zinc-200/50">
                            ...
                            <h3 className="text-lg font-medium text-zinc-900 mb-2">Detailed Profiles</h3>
                            <p className="text-zinc-600 text-sm leading-relaxed">Every hospital listing includes comprehensive information about their specialties, infrastructure, and available technologies.</p>
                        </div>
                        <div className="bg-zinc-100/50 p-6 rounded-2xl border border-zinc-200/50">
                            <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-teal-600 shadow-sm mb-4">
                            ...
                            <h3 className="text-lg font-medium text-zinc-900 mb-2">Location Filtering</h3>
                            <p className="text-zinc-600 text-sm leading-relaxed">Easily browse facilities based on your specific Indian state to find the closest and most convenient care options.</p>
                        </div>
                    </div>
                </div>
            </div>
