...
const careInclusions = [
    {
        ...
        desc: "Keeping the elder's room neat and clean.",
...
export default function ElderlyCare() {
    return (
        <section id="elderly-care" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16 overflow-hidden relative">
